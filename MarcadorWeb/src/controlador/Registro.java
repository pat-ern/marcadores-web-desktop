...
public class Registro {
    ...
    public List<Marcador> listarMarcadoresDeCarpeta(int idCarpeta) {
        ...
        try {
            ...
            String query = "SELECT idMarcador, nombreMarcador, url, fechaCreacion, fechaUltimoUso, descMarcador, colorMarcador, usuario, carpeta FROM marcador WHERE carpeta = '" + idCarpeta + "' order by idMarcador";
            PreparedStatement stmt = cnx.prepareStatement(query);
    ...
    public boolean borrarMarcador(String url, Usuario usr) {

        try {
            ConexionBD conexion1 = new ConexionBD();
            Connection cnx = conexion1.obtenerConexion();

            String query = "DELETE FROM marcador WHERE url = '" + url + "' AND usuario = '" + usr.getIdUsuario() + "'";
            PreparedStatement stmt = cnx.prepareStatement(query);
            stmt.execute(); //update
            stmt.close();
            cnx.close();
    ...
    public List<Marcador> listarLosMarcPorUltimaFecha(Usuario usr) {
        ...
        try {
            ...
            String query = "SELECT idMarcador, nombreMarcador, url, fechaCreacion, fechaUltimoUso, descMarcador, colorMarcador, usuario, carpeta FROM marcador WHERE usuario = '" + usr.getIdUsuario() + "' order by fechaUltimoUso";
            PreparedStatement stmt = cnx.prepareStatement(query);
    ...
    public List<Marcador> listarLosMarcPor(Usuario usr) {
    ...
    public Marcador consultarMarcador(String url) {
        ...
        try {
            ...
            String query = "SELECT idMarcador, nombreMarcador, url, fechaCreacion, fechaUltimoUso, descMarcador, colorMarcador, usuario, carpeta FROM marcador WHERE url = '" + url + "'";
            PreparedStatement stmt = cnx.prepareStatement(query);
            ResultSet rs = stmt.executeQuery(); //select
